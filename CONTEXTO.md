...
10. Esta fusión aplica un sistema de prioridades donde Financial Times sobrescribe a Cobas, y Cobas sobrescribe a las fuentes de respaldo. La jerarquía completa (de menor a mayor) es: Yahoo → Ariva → Fundsquare → **Cobas** → FT.
